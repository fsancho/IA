...
to complete-graph [initial-state]
  ...
  [
    ...
    [
      ...
      [
        let applied-state apply-transition ? content
        ...
        [
          ...
          [
            ...
            create-transition-from myself [set rule ? set label first ? set label-color black]
            set color white
        ...
        [
          ...
          create-transition-to past [set rule ? set label first ? set label-color black]
        ]
