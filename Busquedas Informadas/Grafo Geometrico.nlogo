...
to test
  ...
  [
    ...
    [
      ...
      set coste-real 0
      set coste-total coste-real + heuristica
      set activo? true
     ]
    set color green
    set size 2
...
to go
  ...
  [
    let a reduce resalta [memoria] of one-of buscadores with [localizacion = fin]
  ]
  [
    user-message "No hay camino entre los puntos inicial y final"
  ]
end
...
100
Mejor Camino
first [coste-real] of buscadores with [localizacion = fin]
3
1
11
