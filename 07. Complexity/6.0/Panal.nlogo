...
to go
  ask turtles [
    rt 4 * feromona
    fd 1 + ((feromona ^ 2) / 60)
    set feromona feromona + 1     ;; sueltan feromona en el patch
  ]
  diffuse feromona 0.01
  ask patches [
    set feromona feromona * 0.99       ;; se evapora la feromona
    set pcolor scale-color gray feromona 0 20
  ]
  tick
end
...
- Copyright 2003 Uri Wilensky. All rights reserved. See http://ccl.northwestern.edu/netlogo/models/Honeycomb for terms of use.
