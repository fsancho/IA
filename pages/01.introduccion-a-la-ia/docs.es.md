...
\[\[popup description="Tres14. Inteligencia Artificial" objwidth=900px objheight=600px fb\_type="youtube" movid="Ut6gDw\_Onwk"\]\]

\[\[popup description="TecnonautaTV" objwidth=900px objheight=600px fb\_type="youtube" movid="kprlS\_xVdsM"\]\]

\[\[popup description="TecnonautaTV" objwidth=900px objheight=600px fb\_type="youtube" movid="PXmnuXA1lrc"\]\]
...
Sistemas que actúan  
racionalmente
![](http://www.atariarchives.org/deli/artificial_intelligence1.jpg)
...
\[\[popup description="AI: 15 key moments in the story of Artificial Intelligence" title="AI: 15 key moments in the story of Artificial Intelligence" width=900px height=900px fb\_type="iframe" url="http://www.bbc.co.uk/timelines/zq376fr"\]\]