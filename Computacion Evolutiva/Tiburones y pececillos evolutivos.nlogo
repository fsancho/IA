    ...
    ifelse any? banco-en-mi-campo           
        [let mas-cercano min-one-of banco-en-mi-campo [distance myself]
         ifelse distance mas-cercano  < Rango-Seguridad
             ...
             [ foreach sort banco-en-mi-campo [
                  let adjusted-turn-angle Angulo-Giro * exp( ((distance mas-cercano) - (distance ?) ) )
                  aproxima ? adjusted-turn-angle
                  alinea ? adjusted-turn-angle ]]  
         navega]
        [navega]
end
