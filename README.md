...
# Models of the course Artificial Intelligence

[Link](http://www.cs.us.es/~fsancho/?p=inteligencia-artificial-2019-20) from ETSII-US (Ingeniería de Computadores)

In this Github folder you can find the different models that we are using in the classes. The relationship between the content of each of the folders and the course syllabus is as follows:
...
+ **06. Logic**: [Sistemas Basados en Reglas](http://www.cs.us.es/~fsancho/?e=103), [Lógica Proposicional](http://www.cs.us.es/~fsancho/?e=120), [Lógica Difusa](http://www.cs.us.es/~fsancho/?e=97)
...
1. Within each folder you can find more specific information about its content. 
